...
public class Activity5_FragmentsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    private List<Activity5_FragmentParentModel> models;
    ...
    public Activity5_FragmentsAdapter(List<Activity5_FragmentParentModel> models, Context context, String from)
    {
        this.models = models;
    ...
    {
        A5ItemBinding binding;

        public mainViewHolder(A5ItemBinding binding)
        {
    ...
    {
        if (viewType == Activity5_FragmentParentModel.Main)
        {
            A5ItemBinding binding = A5ItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
            return new mainViewHolder(binding);
        }

        else if (viewType == Activity5_FragmentParentModel.Loading)
        {
        ...
        else if (viewType == Activity5_FragmentParentModel.Retry)
        {
        ...
        else if (viewType == Activity5_FragmentParentModel.NotFound)
        {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position)
    {
        ...
        {
            final Activity5_FragmentsMainModel model = (Activity5_FragmentsMainModel) models.get(position);
            ...
            holder1.binding.detail.setText(model.getDetail());
            holder1.binding.buyer.setText(model.getBuyer_name());
    ...
    public void details(final Activity5_FragmentsMainModel model)
    {
        ...
        //----------------------------------------------------------------------------------------------------------
            ...
            binding1.buyer.setText(model.getBuyer_name());
            binding1.driver.setText(model.getDriver_name());
        ...
        try
        {
            JSONArray array = model.getSale_details();
            ...
            public void onShow(DialogInterface dialogInterface)
            {
                ...
                edit.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View view)
                    {
                        ...
                        intent.putExtra("sale_id",model.getId());
                        intent.putExtra("factor_number",model.getFactorNumber());
                        intent.putExtra("date",model.getDate());
                        intent.putExtra("buyer_id",model.getBuyer_id());
                        intent.putExtra("driver_id",model.getDriver_id());
                        ...
                        intent.putExtra("buyer_name",model.getBuyer_name());
                        intent.putExtra("driver_name",model.getDriver_name());
    ...
    private void deleteDialog(final Activity5_FragmentsMainModel model)
    {
    ...
    private void delete(final Activity5_FragmentsMainModel model)
    {
