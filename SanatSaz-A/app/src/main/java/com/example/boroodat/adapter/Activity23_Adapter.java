...
import com.example.boroodat.databinding.A23ItemBinding;
...
public class Activity23_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    private List<Activity23_ParentModel> models;
    ...
    public Activity23_Adapter(List<Activity23_ParentModel> models, Context context, int from, TextView txtName, TextView txtId, AlertDialog alertDialog, String from2)
    {
        this.models = models;
    ...
    public Activity23_Adapter(List<Activity23_ParentModel> models, Context context, int from, String from2)
    {
        this.models = models;
        this.context = context;
        this.from = from;
    ...
    {
        A23ItemBinding binding;

        public mainViewHolder(A23ItemBinding binding)
        {
    ...
    {
        if (viewType == Activity23_ParentModel.Main)
        {
            A23ItemBinding binding = A23ItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
            return new mainViewHolder(binding);
        }

        else if (viewType == Activity23_ParentModel.Loading)
        {
        ...
        else if (viewType == Activity23_ParentModel.Retry)
        {
        ...
        else if (viewType == Activity23_ParentModel.NotFound)
        {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position)
    {
        ...
        {
            final Activity23_MainModel model = (Activity23_MainModel) models.get(position);
            final mainViewHolder holder1 = (mainViewHolder) holder;
            holder1.itemView.setTag(model);

            //-------------------------------------------------------------------------------------------------------

            holder1.binding.sellerName.setText(model.getSeller_name());
            holder1.binding.shopName.setText(model.getShop_name());
            holder1.binding.phoneNumber.setText(model.getPhone_number());
            holder1.binding.address.setText(model.getAddress());
            ...
            holder1.binding.lnr1.setOnLongClickListener(new View.OnLongClickListener()
            {
                ...
                public boolean onLongClick(View view)
                {
                    ...
                    else
                    {
                        ...
                        ((Activity23_Seller) context).changeStatusLnr3();
            ...
            holder1.binding.lnr1.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    if (s1==0)
                    {
                        if (from == 2)
                        {
                            txtName.setText(model.getSeller_name());
    ...
    private void editDialog(final Activity23_MainModel model)
    {
        ...
        binding1.sellerName.setText(model.getSeller_name());
        binding1.shopName.setText(model.getShop_name());
        binding1.phoneNumber.setText(model.getPhone_number());
        binding1.address.setText(model.getAddress());
                ...
                add.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                edit(model,binding1.sellerName.getText().toString(),shop_name1,phone_number1,address1,alertDialog);
                            }
                            else
    ...
    public void edit(final Activity23_MainModel model, final String seller_name,final String shop_name, final String phone_number, final String address, final AlertDialog alertDialog)
    {
        String url = context.getString(R.string.domain) + "api/seller/edit";
        progressDialog.show();

        JSONObject object = new JSONObject();
        try
        {
            object.put("seller_id", model.getId());
        ...
        Response.Listener<JSONObject> listener = new Response.Listener<JSONObject>()
        {
            ...
            public void onResponse(JSONObject response)
            {
                ...
                try
                {
                    ...
                    {
                        model.setSeller_name(seller_name);
