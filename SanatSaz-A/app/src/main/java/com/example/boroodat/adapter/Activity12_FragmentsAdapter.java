...
public class Activity12_FragmentsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    private List<Activity12_FragmentParentModel> models;
    ...
    public Activity12_FragmentsAdapter(List<Activity12_FragmentParentModel> models, Context context, String from)
    {
        this.models = models;
    ...
    {
        A12ItemBinding binding;

        public mainViewHolder(A12ItemBinding binding)
        {
    ...
    {
        if (viewType == Activity12_FragmentParentModel.Main)
        {
            A12ItemBinding binding = A12ItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
            return new mainViewHolder(binding);
        }

        else if (viewType == Activity12_FragmentParentModel.Loading)
        {
        ...
        else if (viewType == Activity12_FragmentParentModel.Retry)
        {
        ...
        else if (viewType == Activity12_FragmentParentModel.NotFound)
        {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position)
    {
        ...
        {
            final Activity12_FragmentMainModel model = (Activity12_FragmentMainModel) models.get(position);
    ...
    private void deleteDialog(final Activity12_FragmentMainModel model)
    {
    ...
    private void delete(final Activity12_FragmentMainModel model)
    {
