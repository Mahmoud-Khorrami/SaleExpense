...
public class Fragment7_DB extends RealmObject
{
    ...
    public Fragment7_DB(int id, String name, String personnel_id, String salary, String earnest, String insurance_tax, String account_id, String account_title, String date, String description)
    {
        this.id = id;
        this.name = name;
