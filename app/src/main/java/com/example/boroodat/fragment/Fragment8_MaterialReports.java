...
import com.example.boroodat.adapter.Fragment8_Adapter;
import com.example.boroodat.database.Fragment8_DB;
import com.example.boroodat.databinding.Fragment5Binding;
import com.example.boroodat.databinding.Fragment8Binding;
...
public class Fragment8_MaterialReports extends Fragment
{

    private Fragment8Binding binding;
    private List<Fragment8_Model> models = new ArrayList<>();
    private Fragment8_Adapter adapter;
    private Realm realm;
    private String from;

    public Fragment8_MaterialReports(String from)
    {
        this.from=from;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        binding.searchView.setOnQueryTextListener(new android.widget.SearchView.OnQueryTextListener()
        {
            ...
            public boolean onQueryTextChange(String newText)
            {
                ...
                List<Fragment8_Model> newList = new ArrayList<>();
                double totalPrice = 0;
                double payment1 = 0;
    ...
    {
        adapter = new Fragment8_Adapter(models, getContext(), binding.totalPrice, binding.payment, binding.remain,from);
        ...
        for (int i = res.size() - 1; i >= 0; i--)
        {
            ...
            models.add(new Fragment8_Model(id, factorNumber, date, sum, payment, account_id));
